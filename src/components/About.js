    ...
    <section className="About container mt-5">
      ...
      <div className="text-center mb-5">
        ...
        <p>
          <center>
            ...
            education opportunities, and career advancement within the
            automotive sector.
          </center>
        </p>
      </div>
      ...
      <div className="text-center mb-5">
        ...
        <p>
          <center>
            ...
            with rewarding career opportunities in the automotive sector through
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <ul>
            <li>
              Simplify the process of booking vehicle service appointments
              through an intuitive and user-friendly online platform.
            </li>
            <li>
              Provide comprehensive automotive courses and training programs to
              equip students with the skills and knowledge needed for successful
              careers in the automotive industry.
            </li>
            <li>
              Prioritize customer satisfaction by delivering reliable services
              and personalized experiences.
            </li>
            <li>
              Commit to excellence in service delivery, education, and career
              placement, maintaining high standards at all times.
            </li>
            <li>
              Promote environmentally responsible practices within the
              automotive service sector, striving for sustainable solutions and
              operations.
            </li>
          </ul>
          <br></br>
