...
const LoginRegister = () => {
    ...
    const handleRegister = async (e) => {
        ...
        if (!validateUsername(user)) {
            setFormError('Username must be between 6 and 20 characters and may include letters, numbers, @, and _.');
            return;
        }
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost/Project01/src/components/php/login.php', { user, pass, rememberMe }, {
                headers: {
                    'Content-Type': 'application/json'
                }
            });
            ...
            <div className="form-box login">
                <form onSubmit={handleLogin}>
                    ...
                    <div className="remember-forgot">
                        <label><input type="checkbox" name="rememberMe" checked={formData.rememberMe} onChange={handleChange} />Remember me</label>
